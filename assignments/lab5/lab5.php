<?php
	/* www.tanyalsweeney.com/itc216/assignments/lab5/lab5.php
...
<html>
	...
	<body>
		<?php if($successState == TRUE)
		{ 	//did the user successfully compete the form? ?>
			<h3><?php echo $successMessage;	//Yes? Show the welcome message! Yay! ?></h3>
		<?php } ?>

			<h3>How much did you spend????</h3>
			<form name = "lunch_cost_form" action = "lab5.php" method = "get">
				First Name:
